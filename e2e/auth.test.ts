...
test.describe('Authentication with Real PocketBase', () => {
	...
	test('admin user can access admin routes', async ({ page }) => {
		...
		const { createTestUser, loginUser, deleteTestUser } = await import('./helpers/auth');
