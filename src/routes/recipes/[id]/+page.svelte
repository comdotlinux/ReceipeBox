		...
		<div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
			...
			<div class="mb-8 overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
				{#if getImageUrl()}
					<div class="aspect-w-16 aspect-h-9">
						<img src={getImageUrl()} alt={recipe.title} class="h-64 w-full object-cover" />
					</div>
				{/if}
						...
						{#if $isAdmin}
							<div class="ml-6 flex items-center space-x-3">
								...
								<button
									...
									class="inline-flex items-center rounded-md border border-red-300 bg-white px-4 py-2 text-sm font-medium text-red-700 shadow-sm hover:bg-red-50 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none dark:border-red-600 dark:bg-gray-700 dark:text-red-400 dark:hover:bg-red-900"
								>
									<svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path
											stroke-linecap="round"
			...
			<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
				...
				<div class="lg:col-span-1">
					<div class="sticky top-6 rounded-lg bg-white p-6 shadow dark:bg-gray-800">
				...
				<div class="lg:col-span-2">
					<div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
						<h2 class="mb-6 text-xl font-semibold text-gray-900 dark:text-white">Instructions</h2>
						<div class="space-y-6">
