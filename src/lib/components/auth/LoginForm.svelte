	...
	<div class="mt-6">
		...
		<div class="mt-6 grid grid-cols-2 gap-3">
			<button
               ...
               py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:border-gray-400
               focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none
               disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-800 dark:border-gray-600
			...
			<button
				...
				class="inline-flex w-full justify-center rounded-md border border-gray-200 bg-gray-100 px-4
               py-2 text-sm font-medium text-gray-400 cursor-not-allowed opacity-50
